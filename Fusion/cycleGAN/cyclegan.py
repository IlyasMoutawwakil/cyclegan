...
if LOAD_MODEL:
    ...
    gen_A_to_B = tf.keras.models.load_model(
        f'models/{DATASET}/cycleGAN_e{LOAD_EPOCH:03}_gen_A_to_B')
    # generator: B -> A
    gen_B_to_A = tf.keras.models.load_model(
        f'models/{DATASET}/cycleGAN_e{LOAD_EPOCH:03}_gen_B_to_A')

    # discriminators
    # discriminator: A -> [real/fake]
    disc_A = tf.keras.models.load_model(
        f'models/{DATASET}/cycleGAN_e{LOAD_EPOCH:03}_disc_A')
    # discriminator: B -> [real/fake]
    disc_B = tf.keras.models.load_model(
        f'models/{DATASET}/cycleGAN_e{LOAD_EPOCH:03}_disc_B')
...
TRAIN_BUF = max([TRAIN_A_BUF, TRAIN_B_BUF])
